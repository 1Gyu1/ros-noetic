...
class IndyROSConnector:
    def __init__(self, robot_ip, robot_name):
        ...
        self.indy_state_pub = rospy.Publisher("status", GoalStatusArray, queue_size=10)
        ...
        # Subscribe command
        self.execute_joint_state_sub = rospy.Subscriber("execute_joint_state", JointState, self.execute_joint_state_cb, queue_size=1)
